...
public interface ICamera extends Cloneable {
    void startCamera(int durationInMinutes, double picturesPerSecond, int width, int height, int quality, boolean verticalFlip, boolean horizontalFlip, String path);
    void stopCamera();
}
